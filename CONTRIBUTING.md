...
Please use the [dedicated form](https://github.com/cosmic-plus/js-tx-result/issues/new/choose).

## Pull Requests

1. Fork [js-tx-result](https://github.com/cosmic-plus/js-tx-result).
...
```
git clone https://git.cosmic.plus/js-tx-result
cd js-tx-result
npm run get
```
